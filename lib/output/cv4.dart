...
class CV4 extends StatefulWidget {
  const CV4({Key? key}) : super(key: key);

  @override
  State<CV4> createState() => _CV4State();
}

class _CV4State extends State<CV4> {
  late String uid;
  String? email;
