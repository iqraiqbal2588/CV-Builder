                    ...
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Text(
                            "${nameAndContactDeatils['profession']}",
                          ...
                          Row(
                            children: [
                              ...
                              Text("${nameAndContactDeatils['phone']}",
                                  style: const TextStyle(fontSize: 14))
                            ],
                          ),
                          ...
                          Row(
                            children: [
                              ...
                              Text("${nameAndContactDeatils['email']}",
                                  style: const TextStyle(fontSize: 14))
                            ],
                          ),
                          const SizedBox(height: 20),
                          Text("${nameAndContactDeatils['city']}",
                              style: const TextStyle(
                          ...
                          const SizedBox(height: 10),
                          const Text(
                              "Through my academic journey, 31 applied a strong focus on building my software engineering and programming abilities, I am detail-oriented and meticulous when managing competing priorities within tight deadlines. I work best in roles where utilizing software development allows me to make a positive impact while using creative problem-solving to resolve issues and achieve goals."),
                          const SizedBox(
                            height: 10,
                          ),
                          const Text(
